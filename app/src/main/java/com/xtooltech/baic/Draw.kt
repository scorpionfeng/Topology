...
data class EcuUnit(val x:Float,val y:Float,val width:Float,val height:Float,val color:Int,val title:String,val position:String,val busId:Int,val above:Boolean ,val busName:String)
